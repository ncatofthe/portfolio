window.portfolioI18n = {
  ...
  "Резюме": "Resume",
  "АВТОМАТИЗИРУЮ": "I AUTOMATE",
  "ВАШИ ПРОЦЕССЫ.": "YOUR WORKFLOWS.",
  "NCAT / DEVELOPMENT & AUTOMATION / 2026": "NCAT / DEVELOPMENT & AUTOMATION / 2026",
  "ГОТОВЫХ ПРОЕКТОВ В ПОРТФОЛИО": "SHIPPED PROJECTS IN PORTFOLIO",
  ...
  "Утилита для обработки маркировки табачной продукции в процессах, связанных с «Честным знаком».": "A utility for processing tobacco product markings in workflows related to the Honest Sign system.",
  "Нужно было быстро извлекать данные из PDF с маркировкой, находить нужные коды и готовить результаты для дальнейшей работы сотрудников.": "The task was to extract marking data from PDFs, find the right codes and prepare structured results for employees.",
  "Разработал CLI- и GUI-инструмент: распознавание DataMatrix/QR, разбор GS1-полей, поиск по индексу и экспорт в CSV/JSON/Excel.": "Built a CLI and GUI tool with DataMatrix/QR recognition, GS1 field parsing, indexed search and CSV/JSON/Excel export.",
  "Проектирование сценария обработки, Python-разработка, работа с PDF и кодами, интерфейс на Tkinter, тесты и подготовка Windows-сборки.": "Processing workflow design, Python development, PDF and code handling, Tkinter UI, tests and Windows build preparation.",
  "Рутинный разбор маркировки превращен в повторяемый локальный процесс с поиском и выгрузкой структурированных данных.": "Routine marking analysis became a repeatable local workflow with search and structured data export.",
  ...
  "Локальное приложение для сбора, анализа и экспорта сведений о Windows-компьютерах.": "A local app for collecting, analyzing and exporting Windows workstation data.",
  "Нужно было свести разрозненные TXT-отчеты по рабочим станциям в понятную картину по ОС, процессорам, памяти, дискам и установленному ПО.": "The task was to turn scattered workstation TXT reports into a clear view of operating systems, CPUs, memory, disks and installed software.",
  "Собрал Tkinter-приложение с загрузкой папок, фильтрами, статистикой, проверкой свободного места и ресурсов, журналом и экспортом CSV/Excel.": "Built a Tkinter app with folder loading, filters, statistics, free-space and resource checks, logging and CSV/Excel export.",
  "Архитектура локальной утилиты, парсинг отчетов, диагностика порогов, интерфейс, визуализация и подготовка сценария запуска.": "Local utility architecture, report parsing, threshold diagnostics, interface, visualization and launch workflow.",
  "Инструмент помогает быстрее проводить инвентаризацию и находить рабочие станции, которым нужна проверка или обновление.": "The tool speeds up inventory work and helps identify workstations that need inspection or an upgrade.",
  ...
  "Иммерсивный концепт корпоративного сайта с выразительной типографикой, контрастной сценой и scroll-анимациями.": "An immersive corporate website concept with expressive typography, a high-contrast scene and scroll animations.",
  "Нужно было показать, как можно переосмыслить подачу крупной компании через современный визуальный сценарий и понятную навигацию.": "The goal was to explore a modern visual narrative and clear navigation for a large company.",
  "Собрал чистый HTML/CSS/JS-концепт с preloader, прогрессом прокрутки, адаптивной навигацией, canvas-эффектом и последовательными секциями.": "Built a dependency-free HTML/CSS/JS concept with a preloader, scroll progress, responsive navigation, canvas effects and staged sections.",
