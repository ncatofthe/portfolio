...
def make_resume(filename, role, summary, focus_items, project_items, stack_items):
    ...
    flow += section("Опыт", [
        "<b>Системное администрирование.</b> Поддержка пользователей и рабочих мест, диагностика Windows/Linux, автоматизация внутренних процессов, разработка служебных инструментов и сопровождение внедренных решений.",
        "<b>Разработка продуктов.</b> Создание сайтов, внутренних сервисов, ботов, интеграций и прикладных утилит под задачи компаний, фрилансеров и небольших команд.",
    ], s)
...
make_resume(
    ...
    [
        "10+ компаний получили сайты, сервисы и автоматизацию.",
        "100+ сотрудников работают с внедренными инструментами.",
    ],
    [
    ...
    ["Python", "TypeScript", "React", "Node.js", "FastAPI", "Express", "Fastify", "PostgreSQL", "SQLite", "REST API", "Prisma", "Docker", "Playwright"],
)

make_resume(
    "resume-admin.pdf",
    "Системное администрирование и разработка",
    "Большой практический опыт в системном администрировании и разработке помогает решать задачи пользователей и инфраструктуры через служебные инструменты, автоматизацию и внутренние сервисы.",
    [
